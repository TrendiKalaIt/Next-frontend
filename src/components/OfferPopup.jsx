  ...
  return (
    <div className="fixed inset-16 md:inset-0 z-50 pointer-events-none">
      <div ref={popupRef} className="offer-smooth pointer-events-auto">
        ...
        >
          {/*  Rotating Circle */}
          <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 border border-black border-dashed rounded-full flex items-center justify-center animate-[spin_10s_linear_infinite] bg-gradient-to-r from-red-800 via-red-600 to-red-700 shadow-2xl">
            <svg className="w-full h-full p-1" viewBox="0 0 100 100">
              <path
                id="curve"
                d="M 50 50 m -40 0 a 40 40 0 1 1 80 0 a 40 40 0 1 1 -80 0"
              ...
              <text>
                <textPath
                  ...
                  className="text-[8px] uppercase tracking-[0.2em] fill-white"
                >
                  Christmas Sale •Flat 20% OFF • SANTATK20 •
                </textPath>
              </text>
            </svg>
          </div>
          ...
          {/*  TOOLTIP */}
          <div
            className={`absolute bottom-[115%] right-0 w-72 p-5 bg-white/95 backdrop-blur-xl border border-red-200/50 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] transition-all duration-300 translate-y-4 pointer-events-none z-[60]
            ${
              showTooltip
                ? "opacity-100 translate-y-0"
                : "opacity-0 group-hover:opacity-100 group-hover:translate-y-0"
